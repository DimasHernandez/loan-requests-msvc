...
//
//    @Test
//    void configSQSResultListenerIsNotNull() {
//        assertThat(sqsConfig.sqsListener(sqsAsyncClient, sqsProperties, message -> Mono.empty())).isNotNull();
//    }
//
//    @Test
//    void configSqsResultIsNotNull() {
//        var loggingMetricPublisher = LoggingMetricPublisher.create();
//        assertThat(sqsConfig.configSqsResult(sqsProperties, loggingMetricPublisher)).isNotNull();
//    }
//
//    @Test
//    void configSqsResultWhenEndpointIsNotNull() {
//        var loggingMetricPublisher = LoggingMetricPublisher.create();
